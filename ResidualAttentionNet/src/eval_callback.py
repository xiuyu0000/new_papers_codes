...
class EvalCallBack(Callback):
    ...
    """
    def __init__(self, eval_function, eval_param_dict, rank, interval=1, eval_start_epoch=1, save_best_ckpt=True,
    ...
    def epoch_end(self, run_context):
        ...
        if cur_epoch >= self.eval_start_epoch and (cur_epoch - self.eval_start_epoch) % self.interval == 0:
            ...
            print("Rank {} epoch: {}, {}: {}, eval_cost:{:.2f}".format(self.rank, cur_epoch,
                                                                       self.metrics_name, res, eval_cost),
                  flush=True)
    ...
    def end(self, run_context):
        print("Rank {3} End training, the best {0} is: {1}, the best {0} epoch is {2}".format(self.metrics_name,
                                                                                              self.best_res,
                                                                                              self.best_epoch,
