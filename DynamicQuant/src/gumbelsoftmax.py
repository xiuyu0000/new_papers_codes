...
class GumbleSoftmax(nn.Cell):
    ...
    def sample_gumbel_like(self, template_tensor, eps=1e-10):
        ...
        gumble_samples_tensor = -self.log(eps - self.log(uniform_samples_tensor + eps))
    ...
    def gumbel_softmax_sample(self, logits):
        ...
        soft_samples = self.softmax(gumble_trick_log_prob_samples)
        return soft_samples
