...
echo "bash scripts/run_distribute_train_gpu.sh [DEVICE_NUM] [CONFIG_PATH]"
echo "for example: bash scripts/run_distribute_train_gpu.sh 8 ./default_config.yaml 0.008"
